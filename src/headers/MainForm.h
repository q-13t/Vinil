...
namespace Vinil {
	...
	public:
		System::Windows::Forms::PictureBox^ SongAlbumImage;
		System::Windows::Forms::Label^ SongTitle;
		System::Windows::Forms::Label^ SongAuthor;
		System::Windows::Forms::Label^ SongDurationCurrent;
		System::Windows::Forms::Label^ SongDurationTotal;
	...
	private:
		...
		System::Windows::Forms::TextBox^ SongSearchArea;
		System::Windows::Forms::Button^ SongListBtn;
		System::Windows::Forms::Button^ RecentPlaysButton;
		System::Windows::Forms::SplitContainer^ splitContainer3;
		System::Windows::Forms::Panel^ panel2;
		System::Windows::Forms::SplitContainer^ splitContainer4;
		System::Windows::Forms::SplitContainer^ splitContainer5;
		System::Windows::Forms::TrackBar^ VolumeSlider;
		...
		System::ComponentModel::BackgroundWorker^ SongFiller;
		System::Windows::Forms::Button^ AddDirButton;
		System::Windows::Forms::TableLayoutPanel^ LinearLayoutDirContainer;
		System::Windows::Forms::Panel^ SettingPanel;
		System::Windows::Forms::Button^ SaveDirsButton;
		System::Windows::Forms::Panel^ SongsPanel;
		System::Windows::Forms::TextBox^ PlaylistNameTextArea;
		System::Windows::Forms::ComboBox^ SongSortComboBox;
		System::Windows::Forms::Button^ SavePlayListButton;
		System::Windows::Forms::TableLayoutPanel^ MainSongLinearLayout;
		System::ComponentModel::IContainer^ components;
		System::ComponentModel::BackgroundWorker^ SongListener;
		System::ComponentModel::BackgroundWorker^ AppStateListener;
		System::Windows::Forms::TrackBar^ SongProgress;
		System::Windows::Forms::Button^ DeletePlayListButton;
		System::Windows::Forms::TableLayoutPanel^ PlayListLinearLayout;
		System::ComponentModel::BackgroundWorker^ PlayListsFiller;
		System::Windows::Forms::TableLayoutPanel^ SubSongLinearLayout;
		array<SongContainer^>^ MainSongList = gcnew array<SongContainer^>(0);
		System::Windows::Forms::ToolTip^ SearchToolTip;
		array<SongContainer^>^ SubSongList = gcnew array<SongContainer^>(0);
		static System::Windows::Forms::TableLayoutPanel^ LinearLayoutSongContainer;
		static bool muted = false;
		static bool shuffle = MusicOperator::getShuffle();
		static bool looped = MusicOperator::getLoop();
		static bool canceled = false;
		static System::Threading::Tasks::Task^ uncheckerTask;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager::ResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager::ResourceManager(L"Vinil.src.resx.MainForm", System::Reflection::Assembly::GetExecutingAssembly()));
			...
			this->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"VinilLogo")));
...
#pragma endregion
	...
	private: delegate Void UncheckSong(SongContainer^ SC);
		   //////////////////////////////////////////////////////////////////////////////////////////
		   //UI Operators
		   //////////////////////////////////////////////////////////////////////////////////////////
	private: Void UncheckSongUI(SongContainer^ SC) {
		SC->SongCheckBox_CheckedChanged(this, EventArgs::Empty);
	};
	private:  System::Void DoUncheckSong() {
		UncheckSong^ US = gcnew UncheckSong(this, &MainForm::UncheckSongUI);
		for (size_t i = 0; i < this->MainSongLinearLayout->Controls->Count; i++) {
			...
			if (val->SongCheckBox->Checked) this->Invoke(US, val);
			if (canceled)break;
		}
	}
	...
	private: Void DOUpdateDisplaySongData() {
		...
		if (MusicOperator::getStatus() == sf::Music::Status::Playing) {
			PlayButton->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"Pause")));
		}
		else {
			PlayButton->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"Pause")));
		}
	...
	private: System::Void MuteButton_Click(System::Object^ sender, System::EventArgs^ e) {
		System::ComponentModel::ComponentResourceManager::ResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager::ResourceManager(L"Vinil.src.resx.MainForm", System::Reflection::Assembly::GetExecutingAssembly()));
		if (!muted) {
			this->MuteButton->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"NO Sound")));
			this->muted = true;
			...
			this->muted = false;
			MusicOperator::SetVolume(this->VolumeSlider->Value);
			this->MuteButton->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"Sound")));
		}
	}
	private: System::Void PlayButton_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (MusicOperator::getStatus() == sf::Music::Status::Playing) {
			MusicOperator::Pause();
			PlayButton->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"Play")));
